    ...
    return (
        <div>
            ...
            <div className="flex flex-col-reverse md:flex-row items-center px-5 lg:px-0">
                <div className="mt-3 pl-4 md:mt-0">
                    <h2 className="xl:text-6xl lg:text-4xl text-2xl font-bold xl:leading-tight">Trusted by Hundreds <span className="text-purple-600">Employers</span> with High-Trust Culture</h2>
                ...
                <img className="w-1/2 xl:h-[600px]" src="https://i.ibb.co/MpPQKdJ/pngwing-com-23.png" alt="" />
            </div>
